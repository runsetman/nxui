...
func (s *SettingService) GetHostIp() (string, error) {
	return s.getString("hostIp")
}

func (s *SettingService) SetHostIp(ip string) error {
	return s.setString("hostIp", ip)
}
...
func (s *SettingService) SetCertFile(publicFile string) error {
	return s.setString("webCertFile", publicFile)
}
...
func (s *SettingService) SetKeyFile(privateKey string) error {
	return s.setString("webKeyFile", privateKey)
}
